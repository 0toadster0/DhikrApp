...
export const styles = StyleSheet.create({
  ...
  /** Reminders explainer (step 16): single primary card, vertically centered in former 3-row slot. */
  remindersExplainerRoot: {
    gap: 0,
  },
  remindersIconWrap: {
    alignItems: "center",
  ...
  remindersCard: {
    ...
    alignItems: "center",
    gap: 15,
    backgroundColor: "rgba(45,26,74,0.58)",
    borderRadius: 15,
    borderWidth: 1,
    borderColor: "rgba(196,162,247,0.26)",
    paddingVertical: 15,
